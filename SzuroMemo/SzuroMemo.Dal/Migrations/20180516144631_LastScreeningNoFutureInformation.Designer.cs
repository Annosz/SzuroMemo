...
namespace SzuroMemo.Dal.Migrations
{
    ...
    [Migration("20180516144631_LastScreeningNoFutureInformation")]
    partial class LastScreeningNoFutureInformation
    {
            ...
            modelBuilder.Entity("SzuroMemo.Dal.Entities.MedicalRecord", b =>
                {
                    ...
                    b.Property<bool>("FatherAllergy");

                    b.Property<bool>("FatherAsthma");

                    b.Property<bool>("FatherDiabetes");

                    b.Property<bool>("FatherHeartDisease");

                    b.Property<bool>("FatherObese");

                    b.Property<bool>("FatherTumour");
                    ...
                    b.Property<bool>("MotherAllergy");

                    b.Property<bool>("MotherAsthma");

                    b.Property<string>("MotherBirthName");

                    b.Property<bool>("MotherDiabetes");

                    b.Property<bool>("MotherHeartDisease");

                    b.Property<bool>("MotherObese");

                    b.Property<bool>("MotherTumour");
                    ...
                    b.OwnsOne("SzuroMemo.Dal.Entities.Address", "Address", b1 =>
                        {
                            ...
                            b1.ToTable("MedicalRecord");

                            b1.HasOne("SzuroMemo.Dal.Entities.MedicalRecord")
                                .WithOne("Address")
                                .HasForeignKey("SzuroMemo.Dal.Entities.Address", "MedicalRecordId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
